...
public class StudentAdapter2 extends ArrayAdapter<Student> implements Filterable {
    ...
    public StudentAdapter2(Context context, List<Student> studentList) {
        ...
        easyScoreRef = FirebaseDatabase.getInstance().getReference("Python_easy_scores");
        normalScoreRef = FirebaseDatabase.getInstance().getReference("Python_normal_scores");
        hardScoreRef = FirebaseDatabase.getInstance().getReference("Python_hard_scores");
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.easyScoreTextView.setText("Easy\n" + student.getEasyScore());
        viewHolder.normalScoreTextView.setText("Normal\n" + student.getNormalScore());
        viewHolder.hardScoreTextView.setText("Hard\n" + student.getHardScore());// Set the picture score
    ...
    private void showConfirmationDialog(final Student student) {
        ...
        View dialogView = inflater.inflate(R.layout.confirmation_dialog2, null);
        ...
        btnResetEasyScore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showConfirmationForReset(student, "Python Easy");
                dialog.dismiss();
            }
        });
        ...
        btnResetNormalScore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showConfirmationForReset(student, "Python normal");
                dialog.dismiss();
            }
        });
        ...
        btnResetHardScore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showConfirmationForReset(student, "Python hard");
                dialog.dismiss();
            }
        });
