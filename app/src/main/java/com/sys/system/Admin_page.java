...
public class Admin_page extends AppCompatActivity  {
    ...
    CardView archives2,java23,python23,message23,ahas,forum,addpython,addJava;
    TextView archives3;
...
/*        Spinner spin = findViewById(R.id.spinnerposition); //spinner is spinner id
        ...
        */
        ...
        addJava = findViewById(R.id.addJava);
        addpython = findViewById(R.id.addpython);


        addpython.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Admin_page.this,python.class);
        ...
        addJava.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Admin_page.this,java.class);
                startActivity(intent);
                finish();
            }
        });
