...
public class hard_set extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_set);

        // Get the home button drawable
        getSupportActionBar().setTitle("Hard mode quiz");
        ...
        mSaveQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question) || TextUtils.isEmpty(option1) || TextUtils.isEmpty(option2) || TextUtils.isEmpty(option3)
                    ...
                    Toast.makeText(hard_set.this, "Please fill in all fields and select an answer option.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseReference questionsRef = database.child("Hard_mode");
                    ...
                    Toast.makeText(hard_set.this, "Question saved successfully!", Toast.LENGTH_SHORT).show();
                }
            }
        });
