...
public class Easy_python extends AppCompatActivity {
    private RecyclerView quizRecycler;
    private Easy_pythons quizAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_easy_python);
        ...
        quizAdapter = new Easy_pythons(this, quizDataSnapshots);
        quizRecycler.setAdapter(quizAdapter);

        float23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),Easy_python_sets.class);
                overridePendingTransition(0,0);
                startActivity(i);
                finish();
            }
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Python_Easy");
