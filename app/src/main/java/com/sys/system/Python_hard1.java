...
public class Python_hard1 extends AppCompatActivity {
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(getApplicationContext(),Python_hard23.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_hard1);
        ...
        mSaveQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question) || TextUtils.isEmpty(option1) || TextUtils.isEmpty(option2) || TextUtils.isEmpty(option3)
                    ...
                    Toast.makeText(Python_hard1.this, "Please fill in all fields and select an answer option.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseReference questionsRef = database.child("Python_Hard").child(questionId); // Use question ID as key
                    ...
                    Toast.makeText(Python_hard1.this, "Question saved successfully!", Toast.LENGTH_SHORT).show();

                    // Navigate back to the quiz_content activity
                    Intent intent = new Intent(Python_hard1.this, Python_hard23.class);
                    startActivity(intent);
