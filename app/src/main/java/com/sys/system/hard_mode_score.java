...
public class hard_mode_score extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hard_mode_score);
        ...
        if (actionBar != null) {
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(hard_mode_score.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
            ...
            if (currentUser != null) {
                ...
                databaseRef.child("Hard_java").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            ...
                            databaseRef.child("Set_A").child(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if (dataSnapshot.exists()) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(hard_mode_score.this, easy2.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
