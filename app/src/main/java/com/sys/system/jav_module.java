...
public class jav_module extends AppCompatActivity {
    @Override
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(jav_module.this, Admin_page.class);
    ...
    private FilesAdapter2 filesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jav_module);
...
// Enable the home button on the action bar
        ...
        getSupportActionBar().setTitle("Java module");
...
// Set the color of the title to black
        ...
        filesAdapter = new FilesAdapter2(this, fileList);
