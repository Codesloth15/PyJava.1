...
*/
   ...
   //
    ...
    private void forgotYourPassword() {
        LayoutInflater li = LayoutInflater.from(student_page.this);
        View promptsView = li.inflate(R.layout.quiz, null);

        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(student_page.this);
        // Set prompts.xml to AlertDialog builder
        alertDialogBuilder.setView(promptsView);

        // Create the AlertDialog with the specified layout parameters
        final AlertDialog alertDialog = alertDialogBuilder.create();
        alertDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        alertDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));

        CardView java = promptsView.findViewById(R.id.java);
        CardView python = promptsView.findViewById(R.id.python);
        ...
        python.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(student_page.this, easy3.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        java.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(student_page.this, easy2.class);
                startActivity(intent);
                finish();
            }
        });

        // Show the AlertDialog after setting up
        alertDialog.show();
    }
