...
public class normal_quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Python Easy Mode");
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Python_quiz");
        mScoreRef = FirebaseDatabase.getInstance().getReference().child("Python_scores");
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                    ...
                    Toast.makeText(normal_quiz.this, "Quiz is already done", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), normal_end.class);
                    startActivity(intent);
    ...
    private void startCountdownTimer() {
        ...
        DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Python_scores").child(userId);
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    Toast.makeText(normal_quiz.this, "You have already completed the quiz", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(normal_quiz.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(normal_quiz.this, normal_score.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
    ...
    private void finishQuiz() {
        ...
        // Show results
        Intent intent = new Intent(this,normal_score.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(normal_quiz.this, java_python.class);
        startActivity(intent);
        super.onBackPressed();
    }
}