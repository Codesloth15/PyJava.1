...
public class python_easy_score2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.hide();
            setContentView(R.layout.activity_python_easy_score2);
            ...
            View_wrong =findViewById(R.id.View_wrong);
            easy = "Python_easy_wrong";
            // Set the title of the action bar

            View_wrong.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    Intent intent = new Intent(getApplicationContext(), Quiz_wrong_A.class);
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(python_easy_score2.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
...
// Retrieve score and total questions from Firebase Realtime Database
            ...
            databaseRef.child("Python_easy_scores").child(currentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        databaseRef.child("Python_Easy").addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(python_easy_score2.this, easy3.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
