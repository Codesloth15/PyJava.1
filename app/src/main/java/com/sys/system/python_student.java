...
public class python_student extends AppCompatActivity {
    @Override
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(python_student.this, modules.class);
    ...
    private FilesAdapter7 filesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_student);

        search = findViewById(R.id.et_search);
        getSupportActionBar().setTitle("Python Modules");
        ...
        filesAdapter = new FilesAdapter7(this, fileList);

        // Set the adapter to the RecyclerView
        filesRecyclerView.setAdapter(filesAdapter);

        // Get a reference to the Firebase database
        databaseRef = FirebaseDatabase.getInstance().getReference("Python");
