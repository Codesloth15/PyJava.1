...
public class Quiz_manager extends AppCompatActivity {
    CardView pyton,java;
    ImageView fab;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getSupportActionBar().setTitle("Quiz Manager");
       ...
       // actionBar.setBackgroundDrawable(new ColorDrawable(Color.parseColor("#D6B4FC")));
        ...
        pyton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(),deleting_quiz2.class);
        ...
        java.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(),deleting_quiz.class);
                overridePendingTransition(0,0);
                startActivity(i);
                finish();
            }
