...
public class hard_mode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Java Hard mode");
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Java_hard_quiz");
            ...
            userQuestionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                        ...
                        Toast.makeText(hard_mode.this, "No questions found for the user", Toast.LENGTH_SHORT).show();
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    Toast.makeText(hard_mode.this, "You have already completed the quiz", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(hard_mode.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(hard_mode.this, hard_mode_score.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(hard_mode.this, easy2.class);
        startActivity(intent);
        super.onBackPressed();
    }
}