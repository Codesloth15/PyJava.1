...
public class Java_setc_setUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_setc_set_up);
        ...
        mSaveQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question) || TextUtils.isEmpty(option1) || TextUtils.isEmpty(option2) || TextUtils.isEmpty(option3)
                    ...
                    Toast.makeText(Java_setc_setUp.this, "Please fill in all fields and select an answer option.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseReference questionsRef = database.child("Java_hard");
                    ...
                    Toast.makeText(Java_setc_setUp.this, "Question saved successfully!", Toast.LENGTH_SHORT).show();
                }
            }
        });
