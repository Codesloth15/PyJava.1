...
public class quiz_content2 extends AppCompatActivity {
    private RecyclerView quizRecycler;
    private QuizAdapter4 quizAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_content2);
        ...
        quizAdapter = new QuizAdapter4(this, quizDataSnapshots);
        quizRecycler.setAdapter(quizAdapter);

        float23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),Easy_set.class);
                overridePendingTransition(0,0);
                startActivity(i);
                finish();
            }
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Java_Easy");
