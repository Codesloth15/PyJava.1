...
public class Python_easy1 extends AppCompatActivity {
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(getApplicationContext(),Easy_python.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_easy1);

        // Get the home button drawable
        getSupportActionBar().setTitle("Python Easy");
        ...
        mSaveQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question) || TextUtils.isEmpty(option1) || TextUtils.isEmpty(option2) || TextUtils.isEmpty(option3)
                    ...
                    Toast.makeText(Python_easy1.this, "Please fill in all fields and select an answer option.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseReference questionsRef = database.child("Python_Easy").child(questionId); // Use question ID as key
                    ...
                    Toast.makeText(Python_easy1.this, "Question saved successfully!", Toast.LENGTH_SHORT).show();

                    // Navigate back to the quiz_content activity
                    Intent intent = new Intent(Python_easy1.this, Easy_python.class);
                    startActivity(intent);
