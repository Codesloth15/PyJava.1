...
public class quiz_content extends AppCompatActivity {
    private RecyclerView quizRecycler;
    private QuizAdapter3 quizAdapter;
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(getApplicationContext(),quiz_category.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Python Quiz Items");
        ...
        quizAdapter = new QuizAdapter3(this, quizDataSnapshots);
        quizRecycler.setAdapter(quizAdapter);

        float23.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),set_normal.class);
                overridePendingTransition(0,0);
                startActivity(i);
                finish();
            }
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Python_quiz");
