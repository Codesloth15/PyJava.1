...
public class FilesAdapter6 extends RecyclerView.Adapter<FilesAdapter6.ViewHolder> {

    private List<FileModel> fileList;
    private Context context;
    private List<FileModel> filteredList;

    public FilesAdapter6(Context context, List<FileModel> fileList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        String title = "File :" + fileModel.getTitle();//file title
        ...
        holder.optionsImageView.setOnClickListener(v -> {
    ...
    private void startDownload(final FileModel fileModel) {
        ...
        .setContentTitle("Download")
                .setContentText("Downloading " + fileModel.getTitle())
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView fileImageView,optionsImageView;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            optionsImageView = itemView.findViewById(R.id.option);
