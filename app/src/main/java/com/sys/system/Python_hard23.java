...
public class Python_hard23 extends AppCompatActivity {
    private RecyclerView quizRecycler;
    private Hard_pythons quizAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_hard23);
        ...
        findViewById(R.id.fill_in_the_blanks).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // User clicked Yes, proceed with reset
                        Intent i = new Intent(getApplicationContext(),fill_and_the_blanks_python_hard.class);
                        startActivity(i);
                        finish();
                    }
                });
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Python_Hard");
