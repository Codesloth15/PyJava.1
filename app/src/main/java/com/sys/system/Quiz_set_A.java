...
public class Quiz_set_A extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Set A");
        ...
        mScoreRef = FirebaseDatabase.getInstance().getReference().child("Hard_java");
        ...
        if (currentUser != null) {
            ...
            DatabaseReference userQuestionsRef = mDatabase.child(userId);
            userQuestionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                        ...
                        // Handle no questions found for the user
                        Log.e("DatabaseError", "No questions found for the user");
                        Toast.makeText(Quiz_set_A.this, "No questions found for the user", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(), hard_mode_end.class);
                        startActivity(intent);
    ...
    private void startCountdownTimer() {
        long totalTime = 2 * 60 * 1000; // 2 minute
        ...
        mCountDownTimer = new CountDownTimer(totalTime, 1000) {
            ...
            public void onFinish() {
                ...
                if (mRadioGroup.getCheckedRadioButtonId() == -1) {
                    // No radio button is selected, proceed to the next question
        ...
        DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Hard_java").child(userId);
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Quiz_set_A.this, "You have already completed the quiz", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void showQuestion() {
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Set_A").child(userId);
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Quiz_set_A.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(Quiz_set_A.this, hard_mode_score.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
    ...
    private void finishQuiz() {
        ...
        // Show results
        Intent intent = new Intent(this,hard_mode_score.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Quiz_set_A.this, easy2.class);
        startActivity(intent);
        super.onBackPressed();
    }
}