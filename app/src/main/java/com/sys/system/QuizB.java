...
public class QuizB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Java Normal Quiz");
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Java_normal");
        mScoreRef = FirebaseDatabase.getInstance().getReference().child("Java_normal_score");
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                    ...
                    Toast.makeText(QuizB.this, "Quiz is already done", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), quiz_b_scores.class);
                    startActivity(intent);
    ...
    private void startCountdownTimer() {
        ...
        if (!isTimerRunning) {
            ...
            DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Java_normal_score").child(userId);
            scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (!dataSnapshot.exists()) {
                        ...
                        Toast.makeText(QuizB.this, "You have already completed the quiz", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void pushToWrongAnswers(String questionText, String selectedOption) {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference wrongAnswersRef = FirebaseDatabase.getInstance().getReference().child("Java_Normal_wrong").child(userId);
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(QuizB.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(getApplicationContext(), quiz_b_scores2.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
    ...
    private void finishQuiz() {
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // Show results
                Intent intent = new Intent(QuizB.this, quiz_b_scores2.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizB.this, easy2.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
        finish();
        super.onBackPressed();
