...
public class QuizC extends AppCompatActivity {
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                    ...
                    Toast.makeText(QuizC.this, "Quiz is already done", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), quiz_c_scores2.class);
                    startActivity(intent);
            ...
            scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (!dataSnapshot.exists()) {
                        ...
                        Toast.makeText(QuizC.this, "You have already completed the quiz", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void speakQuestion() {
        ...
        if (currentUser != null) {
            ...
            DatabaseReference wrongAnswersRef = FirebaseDatabase.getInstance().getReference().child("Java_Hard_wrong").child(userId);
            ...
            scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(QuizC.this);
                        builder.setTitle("Quiz already completed")
                                ...
                                .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent = new Intent(getApplicationContext(), quiz_c_scores.class);
                                        startActivity(intent);
                                        finish();
                                    }
                                });
    ...
    public void onBackPressed() {
        Intent intent = new Intent(QuizC.this, easy2.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
        finish();
        super.onBackPressed();
