...
public class Edit_java extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_java);
        ...
        mSaveQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question) || TextUtils.isEmpty(option1) || TextUtils.isEmpty(option2) || TextUtils.isEmpty(option3)
                    ...
                    Toast.makeText(Edit_java.this, "Please fill in all fields and select an answer option.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseReference questionsRef = database.child("Java_Easy").child(questionId); // Use question ID as key
                    ...
                    Toast.makeText(Edit_java.this, "Question saved successfully!", Toast.LENGTH_SHORT).show();

                    // Navigate back to the quiz_content activity
                    Intent intent = new Intent(Edit_java.this, quiz_content2.class);
                    startActivity(intent);
