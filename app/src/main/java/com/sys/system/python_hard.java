...
public class python_hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_hard);

        getSupportActionBar().setTitle("Python Hard mode");
        ...
        mScoreRef = FirebaseDatabase.getInstance().getReference().child("Python_hard_score");
            ...
            userQuestionsRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                        ...
                        Toast.makeText(python_hard.this, "No questions found for the user", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(getApplicationContext(), python_end.class);
                        startActivity(intent);
    ...
    private void startCountdownTimer() {
        ...
        DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Python_hard_score").child(userId);
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    Toast.makeText(python_hard.this, "You have already completed the quiz", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(python_hard.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(python_hard.this, python_hard_mode.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
    ...
    private void finishQuiz() {
        ...
        // Show results
        Intent intent = new Intent(this,python_hard_mode.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(python_hard.this, java_python.class);
        startActivity(intent);
        super.onBackPressed();
    }
}