...
public class python_module extends AppCompatActivity {
    @Override
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(python_module.this, Admin_page.class);
    ...
    private FilesAdapter3 filesAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_python_module);
...
// Enable the home button on the action bar
        ...
        getSupportActionBar().setTitle("Python module");
...
// Set the color of the title to black
        ...
        filesAdapter = new FilesAdapter3(this, fileList);
