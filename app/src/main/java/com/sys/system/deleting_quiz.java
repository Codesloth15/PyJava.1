...
public class deleting_quiz extends AppCompatActivity {
...
// Check the third item (index 2)
        ...
        DatabaseReference easyRef = FirebaseDatabase.getInstance().getReference("Java_Easy");
        DatabaseReference hard  = FirebaseDatabase.getInstance().getReference("Java_hard");
