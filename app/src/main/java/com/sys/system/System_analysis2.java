...
public class System_analysis2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_system_analysis2);
    ...
    private void deleteFoodItem(View view) {
        AlertDialog.Builder builder = new AlertDialog.Builder(System_analysis2.this);
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(getApplicationContext(), System_analysis2.class);
                startActivity(i);
                overridePendingTransition(0, 0);
                finish();
            }
    ...
    String[] sectionNames = {"Python Easy", "Python Normal", "Python Hard"};
    final String[] databasePaths = {"Python_easy_wrong", "Python_normal_wrong", "Python_hard_wrong"};
            ...
            databaseReference.child(path).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (wrongAnswerCounts.size() == 3) {
                        ...
                        StringBuilder descriptionText = new StringBuilder("Here is the incorrect answer count for different User's Python Difficulty:\n\n");
