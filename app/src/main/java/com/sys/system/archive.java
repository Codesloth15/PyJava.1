...
public class archive extends AppCompatActivity {
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(archive.this, Admin_page.class);
    ...
    private FilesAdapter9 filesAdapter;
...
// Enable the home button on the action bar
        ...
        getSupportActionBar().setTitle("Java Archive");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        filesAdapter = new FilesAdapter9(this, fileList);

        // Set the adapter to the RecyclerView
        filesRecyclerView.setAdapter(filesAdapter);

        // Get a reference to the Firebase database
        databaseRef = FirebaseDatabase.getInstance().getReference("Archive_modules");
