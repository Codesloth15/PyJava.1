...
public class   Quiz_A extends AppCompatActivity {
                ...
                if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                    for (DataSnapshot questionSnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (answerOptions[0].equals(answer)) {
                            ...
                            Toast.makeText(Quiz_A.this, "Correct", Toast.LENGTH_SHORT).show();
    ...
    private void startCountdownTimer() {
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                speech.setImageResource(R.drawable.mute);
                if (mRadioGroup.getCheckedRadioButtonId() == -1) {
    ...
    private void showQuestion() {
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Java_Easy_scores").child(userId);
        DatabaseReference scoresWrong = FirebaseDatabase.getInstance().getReference().child("Java_Easy_wrong").child(userId);
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    builder.setTitle("Quiz already completed")
                            ...
                            .setPositiveButton("Retake Quiz", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    scoresWrong.addListenerForSingleValueEvent(new ValueEventListener() {
                                        @Override
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
               ...
               wrongAnswersRef.addListenerForSingleValueEvent(new ValueEventListener() {
                   @Override
                   public void onDataChange(@NonNull DataSnapshot snapshot) {
                       ArrayList<YourDataModelClass> wrongAnswersList = new ArrayList<>();
                       for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                           // Now you can access the data for each child
                           ...
                           String selectedOption = childSnapshot.child("selectedOption").getValue(String.class);
                           // Create a YourDataModelClass object and add it to the ArrayList
                           YourDataModelClass dataModel = new YourDataModelClass(answer, question, selectedOption);
                           wrongAnswersList.add(dataModel);
                       }
                   }
