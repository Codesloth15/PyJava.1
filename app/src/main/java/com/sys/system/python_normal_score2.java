...
public class python_normal_score2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.hide();
            setContentView(R.layout.activity_python_normal_score2);
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(python_normal_score2.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
...
// Retrieve score and total questions from Firebase Realtime Database
            ...
            databaseRef.child("Python_normal_scores").child(currentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        databaseRef.child("Python_Normal").addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(python_normal_score2.this, easy3.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
