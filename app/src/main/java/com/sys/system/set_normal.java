...
public class set_normal extends AppCompatActivity {
        ...
        mSaveQuestionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question) || TextUtils.isEmpty(option1) || TextUtils.isEmpty(option2) || TextUtils.isEmpty(option3)
                    ...
                    Toast.makeText(set_normal.this, "Please fill in all fields and select an answer option.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    DatabaseReference questionsRef = database.child("Python_quiz");
                    ...
                    Toast.makeText(set_normal.this, "Question saved successfully!", Toast.LENGTH_SHORT).show();
                }
            }
        });
