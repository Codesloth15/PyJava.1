...
public class Python_quiz1 extends AppCompatActivity {
            ...
            case android.R.id.home:
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // If the timer is paused, cancel the countdown timer
                        if (isTimerPaused) {
                            mCountDownTimer.cancel();
                        } else {
                            // If the timer is resumed, start a new countdown timer with the remaining time
                            startCountdownTimer();
                        }

                        // Continue with your existing code to navigate to the menu
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Python Easy Quiz");
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Python_Easy");
        mScoreRef = FirebaseDatabase.getInstance().getReference().child("Python_easy_scores");
        ...
        mDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                    ...
                    Toast.makeText(Python_quiz1.this, "Quiz is already done", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), python_easy_score1.class);
                    startActivity(intent);
    ...
    private void startCountdownTimer() {
        ...
        if (!isTimerRunning) {
            ...
            DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Python_easy_scores").child(userId);
    ...
    private void speakQuestion() {
        speech.setImageResource(R.drawable.volume);
    ...
    private void pushToWrongAnswers(String questionText, String selectedOption,String correctOption) {
        FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
        if (currentUser != null) {
            String userId = currentUser.getUid();
            DatabaseReference wrongAnswersRef = FirebaseDatabase.getInstance().getReference().child("Python_easy_wrong").child(userId);
    ...
    private void showQuestion() {
        ...
        String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
        DatabaseReference scoresRef = FirebaseDatabase.getInstance().getReference().child("Python_easy_scores").child(userId);
        DatabaseReference scoresWrong = FirebaseDatabase.getInstance().getReference().child("Python_easy_wrong").child(userId);
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(Python_quiz1.this);
                    builder.setTitle("Quiz already completed")
                            ...
                            .setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Intent intent = new Intent(Python_quiz1.this, python_easy_score2.class);
                                    startActivity(intent);
                                    finish();
                                }
                            });
    ...
    private void checkAnswer() {
        ...
        if (selectedAnswer.equals(correctAnswer)) {
            ...
            if (currentUser != null) {
                ...
                wrongAnswerData.put("answer", correctAnswer);
    ...
    private void finishQuiz() {
        ...
        scoresRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // Show results
                Intent intent = new Intent(getApplicationContext(), python_easy_score2.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Python_quiz1.this, easy3.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
        finish();
        super.onBackPressed();
