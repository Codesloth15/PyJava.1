...
public class quiz_c_scores extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (actionBar != null) {
            actionBar.hide();
            setContentView(R.layout.activity_quiz_cscores);
            ...
            exit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(quiz_c_scores.this, "Back to QUIZ", Toast.LENGTH_SHORT).show();
...
// Retrieve score and total questions from Firebase Realtime Database
            ...
            databaseRef.child("Java_hard_score").child(currentUser.getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()) {
                        ...
                        databaseRef.child("Java_hard").addListenerForSingleValueEvent(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                if (dataSnapshot.exists()) {
    ...
    public void onBackPressed() {
        Intent intent = new Intent(quiz_c_scores.this, easy2.class);
        startActivity(intent);
        overridePendingTransition(0,0);
        super.onBackPressed();
    }
