   ...
   // FloatingActionButton fabs23;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // fabs23 = findViewById(R.id.fab);
        ...
        ImageView rankImageView = findViewById(R.id.rank);
...
*/
        ...
        easys.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
// Check the third item (index 2)
  ...
  int score = Integer.parseInt(points.getText().toString().trim());
        ...
        ValueEventListener scoreListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (nodesRetrieved[0] == 3) {
                    ...
                    points.setText(String.valueOf(" "+totalScore[0]));
                   // Example: Set total score in a TextView
                }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(easy2.this,student_page.class);
        startActivity(intent);
       // overridePendingTransition(0,0);
        super.onBackPressed();
    }
